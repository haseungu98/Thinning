...
output_path = "output_ver1_naver3/"
...
for image in image_paths:
    ...
    # while cnt != 0:
    #     cnt = 0
    #     y_indices5, x_indices5 = np.where(lb == objectPixel)
    ...
    # '''Stairs solving'''
    # y_indices6, x_indices6 = np.where(lb == objectPixel)
    ...
    # cv2.imwrite(output_path + image + "_post-processing.png", fp)
    
cv2.imwrite(output_path + image + "_skeleton" + ".png", fp)
